        ...
        <div class="subnavbar-inner">
            <div class="container">
                <ul class="mainnav">
                    ...
                    <li <?php uri_match('logs');?> id="activity_log"><a href="<?php echo base_url('admin/activity_log'); ?>" title="View Activity Log"><i class="icon-sitemap"></i><span>Activity Log</span> </a></li>
                </ul>
            </div>
            <!-- /container --> 
        </div>
