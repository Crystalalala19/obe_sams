...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2014 at 03:36 PM
...
--
ALTER TABLE `student`
 ADD PRIMARY KEY (`ID`), ADD UNIQUE KEY `student_id` (`student_id`), ADD KEY `ID` (`ID`), ADD KEY `curriculumID` (`programID`);

--
-- Indexes for table `teacher`
--
ALTER TABLE `teacher`
 ADD PRIMARY KEY (`ID`), ADD UNIQUE KEY `teacher_id` (`teacher_id`), ADD KEY `login_id` (`teacher_id`), ADD KEY `courseID` (`courseID`);
