...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2015 at 02:05 PM
...
(3, 3, '1:30 PM', '3:00 PM', 'TTH', '2', 2015, 'ICT117', '1111111111'),
(4, 4, '3:00 PM', '4:30 PM', 'TTH', '2', 2015, 'ICT117', '1111111111'),
(5, 5, '9:00 AM', '10:30 AM', 'MW', '2', 2015, 'ICT118', '1111111111'),
...
ALTER TABLE `student_course`
 ADD UNIQUE KEY `unique_index` (`courseID`,`classID`,`studentID`,`poID`), ADD KEY `courseID` (`poID`,`studentID`), ADD KEY `studentID` (`studentID`), ADD KEY `classID` (`classID`), ADD KEY `pyID` (`courseID`);
